...
pub const Mock = struct {
    ...
    // fn (*JSC.JSGlobalObject, *JSC.CallFrame) callconv(.C) JSC.JSValue;
    // pub fn call(this: *Mock, _: *JSC.JSGlobalObject, _: *JSC.CallFrame) callconv(.C) JSC.JSValue {
    pub fn call(globalObject: *JSC.JSGlobalObject, callframe: *JSC.CallFrame) callconv(.C) JSC.JSValue {
        ...
        // var mock = globalThis.bunVM().allocator.create(Mock) catch unreachable;
