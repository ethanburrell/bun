...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForSHA512_256Constructor;std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForMock;
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForMockConstructor;std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForExpect;
