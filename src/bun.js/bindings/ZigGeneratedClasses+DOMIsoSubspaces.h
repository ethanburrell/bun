...
std::unique_ptr<IsoSubspace> m_subspaceForSHA512_256Constructor;std::unique_ptr<IsoSubspace> m_subspaceForMock;
std::unique_ptr<IsoSubspace> m_subspaceForMockConstructor;std::unique_ptr<IsoSubspace> m_subspaceForExpect;
